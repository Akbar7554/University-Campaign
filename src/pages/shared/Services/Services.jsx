          ...
          <div className="grid max-w-md gap-8 row-gap-10 sm:mx-auto lg:max-w-full lg:grid-cols-3">
            <div className="flex flex-col sm:flex-row">
              ...
              <div>
                ...
                <p className="mb-3 text-sm text-gray-900">
                  ...
                  for creating and launching professional and visually appealing
                  websites.
                </p>
            ...
            <div className="flex flex-col sm:flex-row">
              ...
              <div>
                ...
                <p className="mb-3 text-sm text-gray-900">
                  Our social media marketing service helps businesses establish
            ...
            <div className="flex flex-col sm:flex-row">
              ...
              <div>
                ...
                <p className="mb-3 text-sm text-gray-900">
                  Our content writing and copywriting service offers
                  high-quality and engaging content that captivates your
